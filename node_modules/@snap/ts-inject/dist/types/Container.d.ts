...
export declare class Container<Services = {}> {
     ...
     * ```
     */
    static provides<Token extends TokenType, Service>(fn: InjectableFunction<{}, [], Token, Service>): Container<AddService<{}, Token, Service>>;
    /**
     ...
     */
    static providesValue<Token extends TokenType, Service>(token: Token, value: Service): Container<AddService<{}, Token, Service>>;
    /**
     ...
     */
    run<Token extends TokenType, Tokens extends readonly ValidTokens<Services>[], Service>(fn: InjectableFunction<Services, Tokens, Token, Service>): this;
    /**
     ...
     */
    provides<AdditionalServices, Dependencies, FulfilledDependencies extends Dependencies>(this: Container<FulfilledDependencies>, container: PartialContainer<AdditionalServices, Dependencies>): Container<AddServices<Services, AdditionalServices>>;
    /**
     ...
     */
    provides<AdditionalServices>(container: Container<AdditionalServices>): Container<AddServices<Services, AdditionalServices>>;
    /**
     ...
     */
    provides<Token extends TokenType, Tokens extends readonly ValidTokens<Services>[], Service>(fn: InjectableFunction<Services, Tokens, Token, Service>): Container<AddService<Services, Token, Service>>;
    /**
     ...
     *          `provides` calls.
     */
    providesValue: <Token extends TokenType, Service>(token: Token, value: Service) => Container<AddService<Services, Token, Service>>;
    /**
     ...
     */
    appendValue: <Token extends keyof Services, Service extends ArrayElement<Services[Token]>>(token: Token, value: Service) => Container<Services>;
    /**
     ...
     */
    appendClass: <Token extends keyof Services, Tokens extends readonly ValidTokens<Services>[], Service extends ArrayElement<Services[Token]>>(token: Token, cls: InjectableClass<Services, Service, Tokens>) => Container<Services>;
    /**
     ...
     */
    append: <Token extends keyof Services, Tokens extends readonly ValidTokens<Services>[], Service extends ArrayElement<Services[Token]>>(fn: InjectableFunction<Services, Tokens, Token, Service>) => Container<Services>;
